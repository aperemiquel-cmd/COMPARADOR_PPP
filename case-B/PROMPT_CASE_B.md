# PROMPT — Caso B: Codex (agente único)

> Copiar y ejecutar este prompt completo en Codex al inicio de la sesión.  
...
ENTREGABLES REQUERIDOS (en orden de prioridad):
  ...
  6. RESULTS_B.md           — log de decisiones de diseño y observaciones
...
Documenta cada decisión de diseño relevante en RESULTS_B.md conforme avances.
```
...
*Ver `docs/RUBRICA_EVALUACION.md` para la plantilla completa de RESULTS_B.md*
